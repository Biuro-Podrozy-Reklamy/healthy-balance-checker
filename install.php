...
('food_descr_top_fats', 'Description - fats (top)', 'What fats, oils, and spreads do you use on a regular basis?<br />Select the ones below that you use.<br />When you’re done, click ‘Next’.', NOW(), '2. Food Intake', 0),
('food_descr_top_water', 'Description - water (top)', 'How many glasses of water do you drink each day? Add the number of glasses you drink on a typical day. When you’re done, click ‘Next’.', NOW(), '2. Food Intake', 0),
...
('results_descr_top', 'Description - top', 'You’re done! See below for your results. Compare your daily plate with the recommended daily plate, and see some great tips tailored for you to help balance your energy levels by what you eat, drink and how active you are.', NOW(), '5. Results', 0),
